                ...
                <a href="{{ route('overview') }}" 
                   class="flex items-center justify-between w-full px-4 py-3 rounded-xl border border-gray-200 shadow-sm transition-all duration-200 text-left
                    ...
                    <div class="flex items-center gap-3 min-w-0 overflow-hidden">
                        <div class="w-8 h-8 {{ !$currentCategory ? 'bg-orange-200 text-orange-600' : 'bg-yellow-100 text-orange-500' }} rounded-full flex items-center justify-center text-sm shrink-0">
            ...
            <li>
                <a href="{{ route('overview', ['kategori' => $category->category_job]) }}" 
                   class="flex items-center justify-between w-full px-4 py-3 rounded-xl border border-gray-200 shadow-sm transition-all duration-200 text-left
                    ...
                    <div class="flex items-center gap-3 min-w-0 overflow-hidden">
                        <div class="w-8 h-8 {{ strtolower($currentCategory) === strtolower($category->category_job) ? 'bg-orange-200 text-orange-600' : 'bg-yellow-100 text-orange-500' }} rounded-full flex items-center justify-center text-sm shrink-0">
